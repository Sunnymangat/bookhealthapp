...
import '../appointmentcss/HospitalAppointment.css'
...
const HospitalAppointment = ({val,close}) => {
  ...
  return (
    ...
    <div className="hospitalAppointment">
        ...
        <br/>
        <span className="signup-textstyle">
        <input type="radio" name="meetWith" value="Specialist"/>Specialist</span><br/>
        <span className="signup-textstyle">
        <input type="radio" name="meetWith" value="Normal" />Normal</span>
        <br/><br/>       
